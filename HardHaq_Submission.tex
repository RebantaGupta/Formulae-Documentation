...
\begin{minipage}{0.49\textwidth}
    \includegraphics[width=\linewidth]{paul_trap_schematic.png}
...
\centering
\begin{minipage}{0.49\textwidth}
    \includegraphics[width=\linewidth]{dc_endcaps.png}
...
\centering
\begin{minipage}{0.49\textwidth}
    \includegraphics[width=\linewidth]{vacuum_mean_free_path.png}
...
\begin{minipage}{0.49\textwidth}
    \raggedright
    \small
    Surrounding the electrodes is the vacuum region, which is not merely a passive environment but a critical requirement. By minimizing collisions with background gas molecules, the vacuum preserves ion coherence, reduces heating, and allows long trapping times. The mean free path \(\lambda\) is given by:
...
\[
    ...
    Achieving ultra-high vacuum ensures that \(\lambda\) is much larger than the trap dimensions, suppressing ion loss due to scattering.
\end{minipage}
\end{figure}
...
\centering
\begin{minipage}{0.49\textwidth}
    \includegraphics[width=\linewidth]{trap_interplay.png}
...
\begin{minipage}{0.49\textwidth}
    \raggedright
    \small
    Together, these three components—RF rods for radial confinement, DC endcaps for axial stability, and the vacuum region for isolation—form a carefully balanced system. Stable confinement emerges only when dynamic and static potentials are combined in a low-pressure environment, reflecting the fundamental design principle of the Paul trap.
\end{minipage}
\end{figure}
...
\centering
\begin{minipage}{0.49\textwidth}
    \includegraphics[width=\linewidth]{trap_geometry.png}
